...
| Relational layer (SQL) | `com.litedb.relational` | `Catalog`, `TableSchema`, `IndexDef`, `RelationalEngine` | 🟡 Phase 3 — DDL + DML + `CREATE INDEX` (multiple indexes) + query planner (index-scan vs full-scan) |
